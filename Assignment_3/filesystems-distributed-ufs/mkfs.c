...
int main(int argc, char *argv[]) {
    ...
    //
    rc = pwrite(fd, &b, UFS_BLOCK_SIZE, s.data_bitmap_addr * UFS_BLOCK_SIZE);//skip these many bytes: s.data_bitmap_addr * UFS_BLOCK_SIZE and write these many: UFS_BLOCK_SIZE
    assert(rc == UFS_BLOCK_SIZE);
